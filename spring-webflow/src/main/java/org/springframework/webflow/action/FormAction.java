 ...
 * then caching them in the configured {@link #getFormObjectScope() form object scope} and {@link #getFormErrorsScope()
 * form errors scope}, respectively. Also {@link #registerPropertyEditors(PropertyEditorRegistry) installs} any custom
 ...
 * <li>Another optional ook method is {@link #registerPropertyEditors(PropertyEditorRegistry)}. By overriding it you can
 * register any required property editors for your form. Instead of overriding this method, consider setting an explicit
 * {@link org.springframework.beans.PropertyEditorRegistrar} strategy as a more reusable way to encapsulate custom
 * PropertyEditor installation logic.</li>
...
public class FormAction extends MultiAction implements InitializingBean {
	 ...
	 * <p>
	 * NOTE: This action method is not designed to be overidden and might become <code>final</code> in a future version
